<nav class="nav">
    <ul class="nav__list container">
        <?php foreach ($categories as $category_link): ?>
        <?php $class_name = ($category === $category_link['name']) ? "nav__item--current" : "";?>
            <li class="nav__item <?=$class_name; ?>">
                <a href="all-lots.php?category=<?=$category_link['name']; ?>"><?=$category_link['name']; ?></a>
            </li>
        <?php endforeach; ?>
    </ul>
</nav>
                ...
                <div class="lot__info">
                    ...
                    <div class="lot__state">
                        <div class="lot__rate">
                            ...
                            <span class="lot__cost"><?=add_currency_to_price(format_price(get_current_price($lot['initial_rate'], $lot['current_rate'])), 'rub', 'р'); ?></span>
                        </div>
                        <?php $finishing_classname = get_dt_range($lot['date_close'])[0] < 24  ? "timer--finishing" : ""; ?>
